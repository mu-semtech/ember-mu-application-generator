...
```
ember install https://github.com/mu-semtech/ember-mu-application-generator.git
...
```
ember install https://github.com/mu-semtech/ember-mu-application-generator.git#tag
ember install https://github.com/mu-semtech/ember-mu-application-generator.git#branch
```
...
```
ember install https://github.com/mu-semtech/ember-mu-application-generator.git#ember-2.14
```
